...
namespace UnityGameFramework
{
    ...
    public sealed class BaseComponent : GameFrameworkComponent
    {
        ...
        [SerializeField]
        private string m_VersionHelperTypeName = "UnityGameFramework.DefaultVersionHelper";

        [SerializeField]
        private string m_LogHelperTypeName = "UnityGameFramework.DefaultLogHelper";

        [SerializeField]
        private string m_CompressionHelperTypeName = "UnityGameFramework.DefaultCompressionHelper";

        [SerializeField]
        private string m_JsonHelperTypeName = "UnityGameFramework.DefaultJsonHelper";
