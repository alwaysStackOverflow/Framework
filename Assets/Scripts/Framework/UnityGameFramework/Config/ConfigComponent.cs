...
namespace UnityGameFramework
{
    ...
    public sealed class ConfigComponent : GameFrameworkComponent
    {
        ...
        [SerializeField]
        private string m_ConfigHelperTypeName = "UnityGameFramework.DefaultConfigHelper";
        ...
        {
            m_EventComponent.Fire(LoadConfigSuccessEventArgs.Create(e));
        }

        private void OnReadDataFailure(object sender, ReadDataFailureEventArgs e)
        {
            Log.Warning("Load config failure, asset name '{0}', error message '{1}'.", e.DataAssetName, e.ErrorMessage);
            m_EventComponent.Fire(LoadConfigFailureEventArgs.Create(e));
        }

        private void OnReadDataUpdate(object sender, ReadDataUpdateEventArgs e)
        {
            m_EventComponent.Fire(LoadConfigUpdateEventArgs.Create(e));
        }

        private void OnReadDataDependencyAsset(object sender, ReadDataDependencyAssetEventArgs e)
        {
            m_EventComponent.Fire(LoadConfigDependencyAssetEventArgs.Create(e));
        }
    }
}
