...
namespace UnityGameFramework
{
    ...
    public sealed class DataTableComponent : GameFrameworkComponent
    {
        ...
        [SerializeField]
        private string m_DataTableHelperTypeName = "UnityGameFramework.DefaultDataTableHelper";
        ...
        {
            m_EventComponent.Fire(LoadDataTableSuccessEventArgs.Create(e));
        }

        private void OnReadDataFailure(object sender, ReadDataFailureEventArgs e)
        {
            Log.Warning("Load data table failure, asset name '{0}', error message '{1}'.", e.DataAssetName, e.ErrorMessage);
            m_EventComponent.Fire(LoadDataTableFailureEventArgs.Create(e));
        }

        private void OnReadDataUpdate(object sender, ReadDataUpdateEventArgs e)
        {
            m_EventComponent.Fire(LoadDataTableUpdateEventArgs.Create(e));
        }

        private void OnReadDataDependencyAsset(object sender, ReadDataDependencyAssetEventArgs e)
        {
            m_EventComponent.Fire(LoadDataTableDependencyAssetEventArgs.Create(e));
        }
    }
}
