...
namespace UnityGameFramework
{
    ...
    public sealed class ProcedureComponent : GameFrameworkComponent
    {
        ...
        [SerializeField]
        private List<string> m_AvailableProcedureTypeNames = null;
        ...
        {
            ProcedureBase[] procedures = new ProcedureBase[m_AvailableProcedureTypeNames.Count];
		...
		public void AddProcedure<T>(T procedure) where T : ProcedureBase
		{
			m_ProcedureManager?.AddProcedure(procedure);
		}

		public void AddProcedure(params ProcedureBase[] procedure)
		{
			m_ProcedureManager?.AddProcedure(procedure);
		}
