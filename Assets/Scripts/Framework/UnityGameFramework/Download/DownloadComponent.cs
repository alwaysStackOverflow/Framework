...
namespace UnityGameFramework
{
    ...
    public sealed class DownloadComponent : GameFrameworkComponent
    {
        ...
        [SerializeField]
        private string m_DownloadAgentHelperTypeName = "UnityGameFramework.UnityWebRequestDownloadAgentHelper";
        ...
        private void OnDownloadFailure(object sender, GameFramework.Download.DownloadFailureEventArgs e)
        {
            ...
            m_EventComponent.Fire(DownloadFailureEventArgs.Create(e));
        }
    }
}
