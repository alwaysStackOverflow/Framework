...
namespace UnityGameFramework
{
    ...
    public sealed class ResourceComponent : GameFrameworkComponent
    {
        ...
        [SerializeField]
        private string m_ResourceHelperTypeName = "UnityGameFramework.DefaultResourceHelper";

        [SerializeField]
        private ResourceHelperBase m_CustomResourceHelper = null;

        [SerializeField]
        private string m_LoadResourceAgentHelperTypeName = "UnityGameFramework.DefaultLoadResourceAgentHelper";
