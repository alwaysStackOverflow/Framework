...
namespace UnityGameFramework
{
    ...
    public sealed partial class UIComponent : GameFrameworkComponent
    {
        ...
        [SerializeField]
        private string m_UIFormHelperTypeName = "UnityGameFramework.DefaultUIFormHelper";

        [SerializeField]
        private UIFormHelperBase m_CustomUIFormHelper = null;

        [SerializeField]
        private string m_UIGroupHelperTypeName = "UnityGameFramework.DefaultUIGroupHelper";
        ...
        {
            m_EventComponent.Fire(OpenUIFormSuccessEventArgs.Create(e));
        }
