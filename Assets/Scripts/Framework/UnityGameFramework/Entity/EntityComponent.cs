...
namespace UnityGameFramework
{
    ...
    public sealed partial class EntityComponent : GameFrameworkComponent
    {
        ...
        [SerializeField]
        private string m_EntityHelperTypeName = "UnityGameFramework.DefaultEntityHelper";

        [SerializeField]
        private EntityHelperBase m_CustomEntityHelper = null;

        [SerializeField]
        private string m_EntityGroupHelperTypeName = "UnityGameFramework.DefaultEntityGroupHelper";
        ...
        {
            m_EventComponent.Fire(ShowEntitySuccessEventArgs.Create(e));
        }
