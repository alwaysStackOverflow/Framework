...
namespace UnityGameFramework
{
    ...
    public sealed partial class SoundComponent : GameFrameworkComponent
    {
        ...
        [SerializeField]
        private string m_SoundHelperTypeName = "UnityGameFramework.DefaultSoundHelper";

        [SerializeField]
        private SoundHelperBase m_CustomSoundHelper = null;

        [SerializeField]
        private string m_SoundGroupHelperTypeName = "UnityGameFramework.DefaultSoundGroupHelper";

        [SerializeField]
        private SoundGroupHelperBase m_CustomSoundGroupHelper = null;

        [SerializeField]
        private string m_SoundAgentHelperTypeName = "UnityGameFramework.DefaultSoundAgentHelper";
        ...
        private void OnPlaySoundSuccess(object sender, GameFramework.Sound.PlaySoundSuccessEventArgs e)
        {
            ...
            m_EventComponent.Fire(PlaySoundSuccessEventArgs.Create(e));
        }
