...
namespace UnityGameFramework
{
    ...
    public sealed class LocalizationComponent : GameFrameworkComponent
    {
        ...
        [SerializeField]
        private string m_LocalizationHelperTypeName = "UnityGameFramework.DefaultLocalizationHelper";
        ...
        {
            m_EventComponent.Fire(LoadDictionarySuccessEventArgs.Create(e));
        }

        private void OnReadDataFailure(object sender, ReadDataFailureEventArgs e)
        {
            Log.Warning("Load dictionary failure, asset name '{0}', error message '{1}'.", e.DataAssetName, e.ErrorMessage);
            m_EventComponent.Fire(LoadDictionaryFailureEventArgs.Create(e));
        }

        private void OnReadDataUpdate(object sender, ReadDataUpdateEventArgs e)
        {
            m_EventComponent.Fire(LoadDictionaryUpdateEventArgs.Create(e));
        }

        private void OnReadDataDependencyAsset(object sender, ReadDataDependencyAssetEventArgs e)
        {
            m_EventComponent.Fire(LoadDictionaryDependencyAssetEventArgs.Create(e));
        }
    }
}
