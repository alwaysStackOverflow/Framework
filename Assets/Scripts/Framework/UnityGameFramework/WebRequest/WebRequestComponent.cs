...
namespace UnityGameFramework
{
    ...
    public sealed class WebRequestComponent : GameFrameworkComponent
    {
        ...
        [SerializeField]
        private string m_WebRequestAgentHelperTypeName = "UnityGameFramework.UnityWebRequestAgentHelper";
        ...
        {
            m_EventComponent.Fire(WebRequestStartEventArgs.Create(e));
        }

        private void OnWebRequestSuccess(object sender, GameFramework.WebRequest.WebRequestSuccessEventArgs e)
        {
            m_EventComponent.Fire(WebRequestSuccessEventArgs.Create(e));
        }
        ...
        private void OnWebRequestFailure(object sender, GameFramework.WebRequest.WebRequestFailureEventArgs e)
        {
            ...
            m_EventComponent.Fire(WebRequestFailureEventArgs.Create(e));
        }
    }
}
