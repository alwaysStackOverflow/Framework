...
namespace UnityGameFramework
{
    ...
    public sealed partial class DebuggerComponent : GameFrameworkComponent
    {
        ...
        private void DrawDebuggerWindowIcon(int windowId)
        {
            ...
            string fps = $"<color=#{color.r:x2}{color.g:x2}{color.b:x2}{color.a:x2}><b>FPS: {m_FpsCounter.CurrentFps:F2}</b></color>";
            GUILayout.Label(fps, GUILayout.Width(100f), GUILayout.Height(20f));

            if(TimeInfo.Delay > 0)
            {
				Color32 pingColor = Color.green;
				if (TimeInfo.Delay > 200)
				{
					pingColor = Color.red;
				}
				else if (TimeInfo.Delay > 100)
				{
					pingColor = Color.red;
				}
				string ping = $"<color=#{pingColor.r:x2}{pingColor.g:x2}{pingColor.b:x2}{pingColor.a:x2}><b>Ping: {TimeInfo.Delay}ms</b></color>";
				GUILayout.Label(ping, GUILayout.Width(100f), GUILayout.Height(20f));
			}

			if (GUILayout.Button("More Info", GUILayout.Width(100f), GUILayout.Height(40f)))
			{
