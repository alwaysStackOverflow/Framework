...
namespace UnityGameFramework.Editor
{
    ...
    internal static class BuildSettings
    {
        ...
        {
            s_ConfigurationPath = EditorType.GetConfigurationPath<BuildSettingsConfigPathAttribute>() ?? Utility.Path.GetRegularPath(Path.Combine(Application.dataPath, "GameFramework/Configs/BuildSettings.xml"));
