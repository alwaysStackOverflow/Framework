...
namespace UnityGameFramework.Editor.ResourceTools
{
    ...
    public sealed class ResourceCollection
    {
        ...
        {
            m_ConfigurationPath = EditorType.GetConfigurationPath<ResourceCollectionConfigPathAttribute>() ?? Utility.Path.GetRegularPath(Path.Combine(Application.dataPath, "GameFramework/Configs/ResourceCollection.xml"));
