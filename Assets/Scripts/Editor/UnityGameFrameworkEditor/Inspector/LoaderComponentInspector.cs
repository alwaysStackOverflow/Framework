...
{
    [CustomEditor(typeof(LoaderComponent))]
    internal sealed class LoaderComponentInspector : GameFrameworkInspector
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            LoaderComponent t = (LoaderComponent)target;
        ...
        {
            m_ProcedureTypeNames = EditorType.GetRuntimeTypeNames(typeof(ProcedureBase));
