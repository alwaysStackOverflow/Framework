...
namespace UnityGameFramework.Editor
{
    ...
    internal sealed class BaseComponentInspector : GameFrameworkInspector
    {
        ...
        private void RefreshTypeNames()
        {
            ...
            versionHelperTypeNames.AddRange(EditorType.GetRuntimeTypeNames(typeof(Version.IVersionHelper)));
            ...
            logHelperTypeNames.AddRange(EditorType.GetRuntimeTypeNames(typeof(GameFrameworkLog.ILogHelper)));
            ...
            compressionHelperTypeNames.AddRange(EditorType.GetRuntimeTypeNames(typeof(Utility.Compression.ICompressionHelper)));
            ...
            jsonHelperTypeNames.AddRange(EditorType.GetRuntimeTypeNames(typeof(Utility.Json.IJsonHelper)));
