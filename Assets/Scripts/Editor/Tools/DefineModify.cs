...
public class DefineModify : OdinEditorWindow
{
	...
	private static readonly string[] AssemblyPath = new string[]
	{
		...
		"Assets/Scripts/Client/Framework/UnityGameFramework/UnityGameFramework.asmdef",
		"Assets/Scripts/Loader/Loader.asmdef",
		"Assets/Scripts/Common/Common.asmdef",
		"Assets/Scripts/Client/Game/Client.asmdef",
	...
	public static AssemblyDefinitionFile GetAssemblyDefinitionFile(string assemblyPath)
	{
		...
		return JsonConvert.DeserializeObject<AssemblyDefinitionFile>(File.ReadAllText(assemblyPath));
	}
	...
	public static void AddAssemblyDefineSymbol(string assemblyPath, string defineSymbol)
	{
		...
		File.WriteAllText(assemblyPath, JsonConvert.SerializeObject(info));
	}
	...
	{
		AddScriptingDefineSymbol("ENABLE_IL2CPP");
		AddAssemblyDefineSymbol("ENABLE_IL2CPP");
	}

	[Button("移除 启用IL2CPP 宏定义", ButtonSizes.Large)]
	public void RemoveIL2CPPDefineSymbolBtn()
	{
		RemoveAssemblyDefineSymbol("ENABLE_IL2CPP");
		RemoveScriptingDefineSymbol("ENABLE_IL2CPP");
	}
}
